<?php $__env->startComponent('admin.components.footer.DataTablesComponents'); ?>
    ...
    <script>
        ...
        oTable.addAjaxUrlWithData('<?php echo e(route('admin.categories.index')); ?>', function (send) {
        ...
        $('.addNewCategory').on('click', function () {
            resetFormToDefault();
            initInputsBasedInType();
            $('#exampleModalLabel').text('<?php echo e(__('admin.create_new_category')); ?>');
        ...
        $('#submit').on('click', function () {
            ...
            let path     = "<?php echo e(route('admin.categories.create')); ?>";
            if ($('#action_type').val() == 'editCategory') {
                path = "<?php echo e(route('admin.categories.update')); ?>"
            }
        ...
        $('body').on('click', '.activation', function () {
            ...
            let path = "<?php echo e(route('admin.categories.activation')); ?>";
        ...
        $('body').on('click', '.deleteItem', function () {
            ...
            let formData   = new FormData();
            formData.append('category_id', categoryId);
            let path = "<?php echo e(route('admin.categories.deleteItem')); ?>";
        ...
        $('body').on('click', '.editCategory', function () {
            resetFormToDefault();
            let categoryId = $(this).data('id');
            let path       = "<?php echo e(route('admin.categories.getCategoryInfo')); ?>";
            let formData   = new FormData();
            ...
            $('#exampleModalLabel').text('<?php echo e(__('admin.update_category')); ?>');
...
<?php /**PATH C:\Users\Emad\Desktop\New folder (6)\resources\views/admin/subviews/categories/scripts.blade.php ENDPATH**/ ?>