            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="<?php echo e((isset($code))?route('admin.orders.update',$code):route('admin.orders.store')); ?>"
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="card">
                                                            <img class="card-img-top cartimage"
                                                                 src="<?php echo e(url('/').$product->image); ?>" alt="image" >
                                                            <div class="card-body">
                                                                <h5 class="product-title"><?php echo e($product->name_ar); ?></h5>
                                                                <h6> السعر : <?php echo e($product->price); ?></h6>
                                                                <h6>
                                                                ...
                                                                <button type="button"
                                                                        ...
                                                                        product_name="<?php echo e($product->name_ar); ?>"
...
<?php echo $__env->make('admin.main_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Emad\Desktop\New folder (6)\resources\views/admin/subviews/orders/form.blade.php ENDPATH**/ ?>