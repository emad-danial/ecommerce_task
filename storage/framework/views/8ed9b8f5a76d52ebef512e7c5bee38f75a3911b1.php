<?php $__env->startComponent('admin.components.footer.DataTablesComponents'); ?>
    ...
    <script>
        ...
        oTable.addAjaxUrlWithData('<?php echo e(route('admin.orders.index')); ?>', function (send) {
        ...
        $('body').on('click', '.deleteItem', function () {
            ...
            let formData   = new FormData();
            formData.append('category_id', categoryId);
            let path = "<?php echo e(route('admin.orders.deleteItem')); ?>";
        ...
        $('body').on('click', '.viewOrder', function () {
            resetFormToDefault();
            let categoryId = $(this).data('id');
            let path       = "<?php echo e(route('admin.orders.getOrdersInfo')); ?>";
            let formData   = new FormData();
            ...
            $('#exampleModalLabel').text('<?php echo e(__('admin.View Order')); ?>');
...
<?php /**PATH C:\Users\Emad\Desktop\New folder (6)\resources\views/admin/subviews/orders/scripts.blade.php ENDPATH**/ ?>