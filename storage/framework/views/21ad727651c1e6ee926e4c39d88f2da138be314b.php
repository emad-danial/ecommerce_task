<?php $__env->startComponent('admin.components.footer.DataTablesComponents'); ?>
    ...
    <script>
        ...
        oTable.addAjaxUrlWithData('<?php echo e(route('admin.products.index')); ?>', function (send) {
                ...
                if(idsArr.length <=0)  {
                    ...
                    swal({
                        ...
                        if (willDelete) {
                            ...
                            let path     = "<?php echo e(route('admin.products.active_all')); ?>";
        ...
        $('body').on('change', '#main_category', function () {
         ...
         var main_category_id =  $( "#main_category option:selected" ).val();
            ...
            let path     = "<?php echo e(route('admin.products.getAllSubCategories')); ?>";
            ajaxRequest(path, formData, function (response) {
        ...
        $('.addNewProduct').on('click', function () {
            resetFormToDefault();
            $('#exampleModalLabel').text('<?php echo e(__('admin.create_new_product')); ?>');
        ...
        $('#submit').on('click', function () {
            ...
            let path     = "<?php echo e(route('admin.products.create')); ?>";
            if ($('#action_type').val() == 'editProduct') {
                path = "<?php echo e(route('admin.products.update')); ?>"
            }
            ajaxRequest(path, formData, function (response) {
                if (response.code == 200) {
                    swal("done!", response.Message, "success");
        ...
        $('body').on('click', '.activation', function () {
            ...
            let path = "<?php echo e(route('admin.products.activation')); ?>";
        ...
        $('body').on('click', '.deleteItem', function () {
            ...
            let path = "<?php echo e(route('admin.products.deleteItem')); ?>";
        ...
        $('body').on('click', '.editProduct', function () {
            resetFormToDefault();
            let serviceID = $(this).data('id');
            let path       = "<?php echo e(route('admin.products.getProductInfo')); ?>";
            let formData   = new FormData();
            ...
            $('#exampleModalLabel').text('<?php echo e(__('admin.update_product')); ?>');
...
<?php /**PATH C:\Users\Emad\Desktop\New folder (6)\resources\views/admin/subviews/products/scripts.blade.php ENDPATH**/ ?>